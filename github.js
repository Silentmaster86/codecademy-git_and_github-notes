...
At this point, your work is ready to be reviewed before it’s integrated into the official project. You’ll start by opening a
pull request.
...
To properly review a pull request, you first need to read the pull request description to understand the changes. Then, you should comment on specific lines of code that require feedback, review the changes thoroughly, and possibly iterate on the review process before finalizing it. The correct order is to read the description, comment on code, review, and then submit the review, potentially repeating the process as needed.
